...
$sectionToRun = $env:selectedSection
...
if ($sectionToRun -eq "kvms") {
...
} elseif ($sectionToRun -eq "apiproducts") {
    # Code for 'cd apiproducts'
    # -------------------------------------API Products----------------------------------------------
    ...
    cd ..
} elseif ($sectionToRun -eq "developers") {
    # Code for 'cd developers'
    # # --------------------------------- Developers ----------------------------------------------------
    ...
    cd ..
} elseif ($sectionToRun -eq "proxies") {
    # # ------------------------------------Proxies------------------------------------------
