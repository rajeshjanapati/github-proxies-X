...
foreach ($jsonFile in $jsonFiles) {
    ...
    $response = Invoke-RestMethod -Uri "https://apigee.googleapis.com/v1/organizations/esi-apigee-x-394004/environments/eval/keyvaluemaps" -Method:POST -Headers $headers -Body ($jsonContent | ConvertTo-Json)
    $response | ConvertTo-Json
    }
